...
public class NVXGpuMemoryInfo {
    ...
    public static final int GL_GPU_MEMORY_INFO_CURRENT_AVAILABLE_VIDMEM_NVX = (int) 36937;
    public static final int GL_GPU_MEMORY_INFO_DEDICATED_VIDMEM_NVX = (int) 36935;
