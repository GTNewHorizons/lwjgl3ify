...
public class APPLEVertexProgramEvaluators {
    ...
    public static void glDisableVertexAttribAPPLE(int arg0, int arg1) {
        throw new UnsupportedOperationException();
    }

    public static void glEnableVertexAttribAPPLE(int arg0, int arg1) {
        throw new UnsupportedOperationException();
    }

    public static boolean glIsVertexAttribEnabledAPPLE(int arg0, int arg1) {
        throw new UnsupportedOperationException();
    }
