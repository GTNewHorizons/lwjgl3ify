...
public class NVTessellationProgram5 {

    public static final int GL_MAX_PROGRAM_PATCH_ATTRIBS_NV = (int) 34520;
    public static final int GL_TESS_CONTROL_PROGRAM_NV = (int) 35102;
