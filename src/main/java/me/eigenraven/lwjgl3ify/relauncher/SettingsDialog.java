...
public class SettingsDialog {
    ...
    private void $$$setupUI$$$() {
        ...
        labelMinJavaVer.setText("Minimum Java required by your mods: ");
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 3;
        gbc.gridwidth = 3;
        ...
        label6.setText("Garbage collector");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.EAST;
        ...
        label7.setText("Custom options (1 per line)");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 3;
        gbc.gridwidth = 2;
