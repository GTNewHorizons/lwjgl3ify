...
Lwjgl3ify depends on:
 - Unimixins (<https://github.com/LegacyModdingMC/UniMixins/>), use at least version 0.1.7 with the GTNHMixins module.
 - GTNHLib (<https://github.com/GTNewHorizons/GTNHLib/>), at least 0.6.2.
